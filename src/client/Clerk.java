...
public class Clerk extends Banker {
    ...
    public void getConstantData(String tableName)
 {
    ...
    private void jbInit() throws Exception {
        ...
        jButton2.setText("Withdrwals");
        jButton3.setText("Deposits");
        jButton4.setText("Requests");
        jButton5.setText("Log Out");
        jButton5.setBounds(new Rectangle(575, 265, 75, 21));
        ...
        jTabbedPane1.addTab("Views", jPanel2);
