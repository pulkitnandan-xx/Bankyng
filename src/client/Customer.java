...
public class Customer extends JFrame {
    ...
    public String usertable="customer";
    ...
    public void getConstantData(String tableName)
 {
    ...
    private void jbInit() throws Exception {
        ...
        jButton2.setText("New Accounts");
        jButton3.setText("Delete Accounts");
        jButton4.setText("Report");
        jButton5.setText("Log Out");  
        
        jButton5.setBounds(new Rectangle(535, 260, 75, 21));
        ...
        jTabbedPane1.addTab("Accounts_Options", jPanel2);
    ...
    private void jButton6_mouseClicked(MouseEvent e)
         ...
         try
                      {
                              ...
                              String sql = "UPDATE cust_login SET password ='"+pass+"' where cust_id="+this.id+"";
     ...
     private void jButton4_mouseClicked(MouseEvent e)
        {
           CustReports c= new CustReports(true,this.id);
    }
}
